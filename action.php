    ...
    //  //Fifth query
     if(isset($_POST['edit'])) 
     {
         ...
         if(isset($_FILES)){
            ...
            $query = "UPDATE addproduct SET pname = '" . $pname . "',pcategory = '" . $pcategory . "',pdescription = '" . $pdescription . "',pprice = " . $pprice . ",Img1='" . $filename . "' WHERE UID=" . $pid;
        if (mysqli_query($conn, $query)) {
            $imgname = "img" . mysqli_insert_id($conn) . "." . $imgType;
        ...
        $query = "UPDATE addproduct SET pname = '" . $pname . "',pcatagory = '" . $pcategory . "',pdescrip = '" . $pdescription . "',pprice = " . $pprice . ",img1='" . $filename. "' WHERE UID=" . $pid;
        if (mysqli_query($conn, $query)) {
